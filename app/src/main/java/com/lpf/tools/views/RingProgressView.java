...
public class RingProgressView extends View {
    ...
    public RingProgressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        startPaint.setColor(Color.parseColor("#FFFF00"));
...
//        canvas.drawCircle(centerX, centerY, radius, paint);
        ...
        canvas.drawArc(rectF, -90, currentProgress * 360 / maxProgress, true, paint);

//        float drawPercent = currentProgress * 360 / maxProgress;

//        if (drawPercent > 0) {
//            // 绘制结束的半圆
//            if (drawPercent <= 1) {
//                canvas.save();
//                canvas.rotate((int) Math.floor(360.0f * drawPercent) - 1, centerX, centerY);
