...
public class CustomViewsActivity extends BaseFeatureActivity {

    @BindView(R.id.custom_view_flow_layout)
    ...
    public void initTagDatas() {
        ...
        tagDatas.add(new TagFlowEntity("showCustomView", ShowCustomViewActivity.class));
    }
